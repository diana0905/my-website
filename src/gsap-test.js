...
class TouchTexture {
  constructor() {
    ...
    this.maxAge = 64;
    this.radius = 0.2 * this.size; // Much larger touch radius for more obvious effect
...
class App {
  ...
  setColorScheme(scheme) {
    ...
    uniforms.uColor1Weight.value = 0.2; // Reduce orange intensity
    uniforms.uColor2Weight.value = 1.2; // Increase navy intensity
  }
